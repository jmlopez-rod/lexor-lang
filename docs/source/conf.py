...
project = u'Lexor Language Styles'
copyright = u'2014, Manuel Lopez'
...
latex_documents = [
  ('index', 'lexorLang.tex', u'Lexor Language Styles Documentation',
